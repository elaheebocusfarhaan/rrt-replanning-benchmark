...
VIDEO_OUTPUT = True
VIDEO_FILENAME = "planner_comparison.mp4"
VIDEO_FPS = 10

# Snapshot settings (optional)
SAVE_FRAME_SNAPSHOTS = False
...
SNAPSHOT_DIR = "comparison_snapshots_video_only"
...
# =============================================================================
# VIDEO / VISUALIZATION RUNNER
# =============================================================================

def run_comparison_2x2_video(seed: int, visualize: bool = True, save_snapshots_flag: bool = False) -> Dict[str, RunResult]:
    set_seed(seed)
    ...
    for frame_idx in range(MAX_FRAMES + 1):
        ...
        if VIDEO_OUTPUT and video_writer is not None:
            video_writer.write(big)
...
def main():
    ...
    print(f"STEP_BUDGET_PER_FRAME: {STEP_BUDGET_PER_FRAME}")
    print(f"VIDEO_OUTPUT: {VIDEO_OUTPUT}")
    print(f"VIDEO_FILENAME: {VIDEO_FILENAME}")
    print(f"VIDEO_FPS: {VIDEO_FPS}")
    print(f"VISUALIZE_COMPARISON_2X2: {VISUALIZE_COMPARISON_2X2}")

    print("\nGenerating 2x2 planner comparison video...")
    results = run_comparison_2x2_video(
        seed=BASE_SEED,
        visualize=VISUALIZE_COMPARISON_2X2,
